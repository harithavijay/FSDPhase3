...
public class AdminRepository<HibernateTemplate> {
	...
	public boolean verifyAdmin(Admin a) {
		Session session=((Object) hibernateTemplate).getSessionFactory().openSession();
		Action transaction=session.beginTransaction();
